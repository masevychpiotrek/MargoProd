      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-3 gap-3 mb-3" data-tutorial="report-counter-good">
              <div>
                <label className="label">Przyrost dobrych</label>
                <input type="number" value={goodCount} onChange={e => { setGoodCount(e.target.value); if (e.target.value) notifyCondition('value-entered') }}
                  placeholder="0" min="0"
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-5 gap-2" data-tutorial="report-counter-times">
              {[
          ...
          {/* Save button */}
          <button onClick={handleSave} disabled={saving} data-tutorial="report-save-btn" data-tutorial="report-save-btn"
