...
const Icons = {
  ...
  complaint:  (<svg width="18" height="18" viewBox="0 0 22 22" fill="none"><path d="M11 2l9 16H2L11 2z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/><path d="M11 9v4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/><circle cx="11" cy="15.5" r="0.6" fill="currentColor" stroke="currentColor" strokeWidth="0.8"/></svg>),
...
const NAV_MANAGER = [
  ...
  { to: '/syringe/reports',      label: '── Raport SA',      icon: Icons.report },
